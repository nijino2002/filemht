...
/**
 * @brief      Verify the hash generated by hashing data indicated by data_elem_ptr.
 *             Here, the data element indicated by data_elem_ptr has the following structure:
 *             ============================
 *             |   index   |    int       |
 *             ----------------------------
 *             |   data    |     char*    |
 ...
 *             ============================
 *
 * @param[in]  fd             MHT file descriptor
 * @param      data_elem_ptr  The data element pointer
 *
 * @return     TRUE will be returned if hash value is matched, otherwise, FALSE will be returned.
 */
 ...
 *         largest index in the current MHT. 
 *         In this function, a new MHT block with the larger index is inserted into the MHT file. Note that this will occur when a new page has been generated by 
 *         the database. According to the design of this algorithm, the index of the new page is larger than the 
 *         biggest index of the block in the original MHT file. Thus, the new block related to the new page will replace the first 
